...
class ActorCritic(object):
    ...
    def create_variables(self):
        ...
        with tf.name_scope("predict_actions"):
            ...
            with tf.variable_scope("actor_network"):
                self.policy_outputs, self.actor_output_state = self.actor_network(self.states)
        ...
        with tf.name_scope("compute_pg_gradients"):
            ...
            with tf.variable_scope("actor_network", reuse=True):
                self.logprobs, _ = self.actor_network(self.states)
    ...
    def sampleAction(self, states):
        ...
        if random.random() < self.exploration:
            out_state = self.session.run(self.actor_output_state, {self.states: states})
